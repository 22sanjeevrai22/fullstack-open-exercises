...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <Link to="/anecdotes/create" style={padding}>
        create new
      </Link>
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          author
          <input type="text" {...author.inputField} />
        </div>
        <div>
          url for more info
          <input type="text" {...info.inputField} />
        </div>
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    handleSetNotification(anecdote);
  };

  const handleSetNotification = (anecdote) => {
  ...
  return (
    <div>
      ...
      <Menu />
      <Routes>
        <Route path="/" element={<Navigate to="/anecdotes" replace />} />
        <Route
          path="/anecdotes"
          element={
